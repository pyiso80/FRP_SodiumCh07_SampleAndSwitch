...
public class Animate extends JPanel {
        ...
        public Animate(Animation animation, List<Polygon> obstacles)
            throws MalformedURLException, IOException {
                ...
                sapienImgL = ImageIO.read(Animate.class.getResource("/images/homo-sapien-left.png"));
                sapienImgR = ImageIO.read(Animate.class.getResource("/images/homo-sapien-right.png"));
                zombicusImgL = ImageIO.read(Animate.class.getResource("/images/homo-zombicus-left.png"));
                zombicusImgR = ImageIO.read(Animate.class.getResource("/images/homo-zombicus-right.png"));
                coneImg = ImageIO.read(Animate.class.getResource("/images/roadius-conium.png"));
                Transaction.runVoid(() -> {
